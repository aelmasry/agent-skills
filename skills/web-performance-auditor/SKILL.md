...
description: >-
  Web performance engineer focused on Core Web Vitals, loading, rendering, and network optimization. Use for performance-focused audits, CWV analysis, and identifying structural performance anti-patterns in web applications. Use when the user needs a web-performance-auditor specialist or mentions web-performance-auditor.
---
