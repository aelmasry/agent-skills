...
name: mcp-builder
description: >-
  Expert Model Context Protocol developer who designs, builds, and tests MCP servers that extend AI agent capabilities with custom tools, resources, and prompts. Use when the user needs a MCP Builder specialist or mentions mcp-builder.
---
