...
name: api-tester
description: >-
  Expert API testing specialist focused on comprehensive API validation, performance testing, and quality assurance across all systems and third-party integrations Use when the user needs a API Tester specialist or mentions api-tester.
---
